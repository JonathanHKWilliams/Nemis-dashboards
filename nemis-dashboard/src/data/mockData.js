...
// ─── Enrollment Data (Grand Bassa County – by school) ─────────────────────────
export const enrollmentData = [
  {
    id: 1,
    school: 'Grand Bassa Central High School', code: 'GBC-011',
    district: 'Buchanan City', county: 'Grand Bassa', type: 'Secondary',
    academicYear: '2025/2026', enrolled: 830, capacity: 1000,
    male: 462, female: 368,
    newEnrollments: 58, withdrawn: 14,
    grades: [
      { grade: 'Grade 7', count: 148 }, { grade: 'Grade 8', count: 162 },
      { grade: 'Grade 9', count: 175 }, { grade: 'Grade 10', count: 145 },
      { grade: 'Grade 11', count: 120 }, { grade: 'Grade 12', count: 80 },
    ],
    trend: 'up', status: 'On Track', lastUpdated: 'Feb 22, 2026',
    officer: 'Benjamin P. Dolo',
  },
  {
    id: 2,
    school: 'Grand Bassa Primary Academy', code: 'GBP-012',
    district: 'Commonwealth District', county: 'Grand Bassa', type: 'Primary',
    academicYear: '2025/2026', enrolled: 530, capacity: 700,
    male: 275, female: 255,
    newEnrollments: 34, withdrawn: 8,
    grades: [
      { grade: 'Grade 1', count: 98 }, { grade: 'Grade 2', count: 92 },
      { grade: 'Grade 3', count: 88 }, { grade: 'Grade 4', count: 85 },
      { grade: 'Grade 5', count: 80 }, { grade: 'Grade 6', count: 87 },
    ],
    trend: 'up', status: 'On Track', lastUpdated: 'Feb 21, 2026',
    officer: 'Miatta C. Cooper',
  },
  {
    id: 3,
    school: 'St. John River Secondary School', code: 'SJR-013',
    district: 'St. John River City', county: 'Grand Bassa', type: 'Secondary',
    academicYear: '2025/2026', enrolled: 615, capacity: 800,
    male: 320, female: 295,
    newEnrollments: 41, withdrawn: 19,
    grades: [
      { grade: 'Grade 7', count: 110 }, { grade: 'Grade 8', count: 118 },
      { grade: 'Grade 9', count: 125 }, { grade: 'Grade 10', count: 102 },
      { grade: 'Grade 11', count: 88 }, { grade: 'Grade 12', count: 72 },
    ],
    trend: 'stable', status: 'On Track', lastUpdated: 'Feb 22, 2026',
    officer: 'Dorothy A. Kpaye',
  },
  {
    id: 4,
    school: 'Commonwealth Technical Institute', code: 'CTI-014',
    district: 'Commonwealth District', county: 'Grand Bassa', type: 'Technical',
    academicYear: '2025/2026', enrolled: 285, capacity: 400,
    male: 190, female: 95,
    newEnrollments: 22, withdrawn: 5,
    grades: [
      { grade: 'Year 1', count: 110 }, { grade: 'Year 2', count: 98 },
      { grade: 'Year 3', count: 77 },
    ],
    trend: 'up', status: 'On Track', lastUpdated: 'Feb 20, 2026',
    officer: 'Miatta C. Cooper',
  },
  {
    id: 5,
    school: 'Neekreen District Primary School', code: 'NDP-015',
    district: 'Neekreen District', county: 'Grand Bassa', type: 'Primary',
    academicYear: '2025/2026', enrolled: 388, capacity: 520,
    male: 198, female: 190,
    newEnrollments: 18, withdrawn: 27,
    grades: [
      { grade: 'Grade 1', count: 72 }, { grade: 'Grade 2', count: 68 },
      { grade: 'Grade 3', count: 65 }, { grade: 'Grade 4', count: 63 },
      { grade: 'Grade 5', count: 60 }, { grade: 'Grade 6', count: 60 },
    ],
    trend: 'down', status: 'At Risk', lastUpdated: 'Feb 18, 2026',
    officer: 'Comfort S. Weah',
  },
  {
    id: 6,
    school: 'District No. 2 Community School', code: 'D2C-016',
    district: 'District No. 2', county: 'Grand Bassa', type: 'Primary',
    academicYear: '2025/2026', enrolled: 420, capacity: 550,
    male: 215, female: 205,
    newEnrollments: 29, withdrawn: 11,
    grades: [
      { grade: 'Grade 1', count: 78 }, { grade: 'Grade 2', count: 74 },
      { grade: 'Grade 3', count: 70 }, { grade: 'Grade 4', count: 68 },
      { grade: 'Grade 5', count: 65 }, { grade: 'Grade 6', count: 65 },
    ],
    trend: 'up', status: 'On Track', lastUpdated: 'Feb 20, 2026',
    officer: 'Samuel K. Sirleaf',
  },
  {
    id: 7,
    school: 'District No. 3 Secondary School', code: 'D3S-017',
    district: 'District No. 3', county: 'Grand Bassa', type: 'Secondary',
    academicYear: '2025/2026', enrolled: 510, capacity: 650,
    male: 270, female: 240,
    newEnrollments: 33, withdrawn: 15,
    grades: [
      { grade: 'Grade 7', count: 98 }, { grade: 'Grade 8', count: 105 },
      { grade: 'Grade 9', count: 102 }, { grade: 'Grade 10', count: 88 },
      { grade: 'Grade 11', count: 72 }, { grade: 'Grade 12', count: 45 },
    ],
    trend: 'stable', status: 'On Track', lastUpdated: 'Feb 19, 2026',
    officer: 'Fatumata B. Koroma',
  },
  {
    id: 8,
    school: 'District No. 4 Faith Academy', code: 'D4F-018',
    district: 'District No. 4', county: 'Grand Bassa', type: 'Primary',
    academicYear: '2025/2026', enrolled: 248, capacity: 360,
    male: 128, female: 120,
    newEnrollments: 15, withdrawn: 22,
    grades: [
      { grade: 'Grade 1', count: 48 }, { grade: 'Grade 2', count: 44 },
      { grade: 'Grade 3', count: 42 }, { grade: 'Grade 4', count: 40 },
      { grade: 'Grade 5', count: 38 }, { grade: 'Grade 6', count: 36 },
    ],
    trend: 'down', status: 'At Risk', lastUpdated: 'Feb 17, 2026',
    officer: 'Alfred B. Duo',
  },
  {
    id: 9,
    school: 'Grand Bassa Vocational Training Centre', code: 'GBV-019',
    district: 'Buchanan City', county: 'Grand Bassa', type: 'Vocational',
    academicYear: '2025/2026', enrolled: 162, capacity: 250,
    male: 118, female: 44,
    newEnrollments: 24, withdrawn: 6,
    grades: [
      { grade: 'Year 1', count: 72 }, { grade: 'Year 2', count: 55 },
  ...
  {
    id: 10,
    school: 'Owensgrove District High School', code: 'ODH-020',
    district: 'Owensgrove District', county: 'Grand Bassa', type: 'Secondary',
    academicYear: '2025/2026', enrolled: 298, capacity: 450,
    male: 160, female: 138,
    newEnrollments: 12, withdrawn: 31,
    grades: [
      { grade: 'Grade 7', count: 62 }, { grade: 'Grade 8', count: 58 },
      { grade: 'Grade 9', count: 55 }, { grade: 'Grade 10', count: 48 },
      { grade: 'Grade 11', count: 42 }, { grade: 'Grade 12', count: 33 },
    ],
    trend: 'down', status: 'Critical', lastUpdated: 'Feb 14, 2026',
    officer: 'Morris T. Boima',
  },
  {
    id: 11,
    school: 'District No. 5 Community Primary', code: 'D5C-021',
    district: 'District No. 5', county: 'Grand Bassa', type: 'Primary',
    academicYear: '2025/2026', enrolled: 312, capacity: 420,
    male: 160, female: 152,
    newEnrollments: 20, withdrawn: 18,
    grades: [
      { grade: 'Grade 1', count: 58 }, { grade: 'Grade 2', count: 55 },
      { grade: 'Grade 3', count: 53 }, { grade: 'Grade 4', count: 50 },
      { grade: 'Grade 5', count: 48 }, { grade: 'Grade 6', count: 48 },
    ],
    trend: 'stable', status: 'On Track', lastUpdated: 'Feb 18, 2026',
    officer: 'Rebecca J. Zarwolo',
  },
  {
    id: 12,
    school: 'Buchanan City Girls High School', code: 'BCG-022',
    district: 'Buchanan City', county: 'Grand Bassa', type: 'Secondary',
    academicYear: '2025/2026', enrolled: 445, capacity: 580,
    male: 0, female: 445,
    newEnrollments: 38, withdrawn: 9,
    grades: [
      { grade: 'Grade 7', count: 88 }, { grade: 'Grade 8', count: 82 },
      { grade: 'Grade 9', count: 78 }, { grade: 'Grade 10', count: 72 },
      { grade: 'Grade 11', count: 68 }, { grade: 'Grade 12', count: 57 },
    ],
    trend: 'up', status: 'On Track', lastUpdated: 'Feb 23, 2026',
    officer: 'Benjamin P. Dolo',
  },
]
